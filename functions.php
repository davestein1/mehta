...
/*}. */
	...
	array ( 'default-image' => '', 'header-text' => true, 'height' => '250', 'width' => '960','default-text-color' => 'FAEBD7' ) ); // try our own values.  
...
function my_credit() {
	printf( '<span style="float: left;">The Official Website of Jake Heggie.&nbsp; %1$s</span> <span style="float: right;">Copyright &#169; %2$s %3$s</span>', 
	wp_loginout() , date_i18n( 'Y' ), '<a href="'. home_url('/contact') .'">Bent Pen Music, Inc.</a>' );
...
function jh_enqueue_scripts(){
	...
	if( true == true ){
		...
		wp_enqueue_style( 'mfp-styles', get_stylesheet_directory_uri() . '/magnific-popup.css' );
	}
}
