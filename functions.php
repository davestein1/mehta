...
function my_credit() {
	printf( '<span style="float: left;">The Official Website of Jake Heggie.&nbsp;s</span> <span style="float: left;" class="loginlink">%1$s</span><span style="float: right;">Copyright &#169; %2$s %3$s</span>', 
