...
function jh_enqueue_scripts(){
	...
	if( true == true ){
		...
		wp_enqueue_script( 'theme', get_stylesheet_directory_uri() . '/js/theme.min.js', array('jquery'), false, false );
		/* wp_enqueue_script( 'theme', get_stylesheet_directory_uri() . '/js/theme.js', array('jquery'), false, false ); /* temp */
		...
		//wp_enqueue_script( 'theme-footer', get_stylesheet_directory_uri() . '/js/theme-footer.js', array('jquery', 'masonry', 'gigpress-js'), false, true );
		wp_enqueue_script( 'theme-footer', get_stylesheet_directory_uri() . '/js/theme-footer.min.js', array('jquery', 'masonry', 'gigpress-js'), false, true );
