jQuery( document ).ready( function($) {
	...
	$('a[rel="smoothscroll_down"]').click(function(){
		...
		var offset_top = $('#scrollwindow').offset().top;
		var offset_top0 = $('#one').offset().top;
		
		$('.smoothscroll_stop').each(function( scroll_stop ) {
		
			var stop_offset = $(this).offset().top;
			
			alert(stop_offset + " " + offset_top);
			
			$('#scrollwindow').animate({ 
				scrollTop:  stop_offset - offset_top
			}, 2000); 
